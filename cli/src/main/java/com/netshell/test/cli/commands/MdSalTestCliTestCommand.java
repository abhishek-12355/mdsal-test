 ...
 */
package com.netshell.test.cli.commands;
...
public class MdSalTestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(MdSalTestCliTestCommand.class);
    protected final MdSalTestCliCommands service;

    public MdSalTestCliTestCommand(final MdSalTestCliCommands service) {
